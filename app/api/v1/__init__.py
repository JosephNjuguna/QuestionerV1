...
api.add_resource(UpvoteQuestion, '/questions/<string:id>/upvote',
                 '/questions/<string:id>/upvote/')
api.add_resource(DownvoteQuestion, '/questions/<string:id>/downvote',
                 '/questions/<string:id>/downvote/')
api.add_resource(PostQuestion, '/question', '/question/',
                 '/questions', '/questions/')
