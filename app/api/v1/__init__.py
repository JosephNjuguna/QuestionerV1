...
api.add_resource(MeetupRsvp,'/meetup/<string:id>/rsvp','/meetup/<string:id>/rsvp/')
api.add_resource(UpvoteQuestion,'/meetup/<string:id>/question/<string:questionid>/upvote','/meetup/<string:id>/question/<string:questionid>/upvote/')
api.add_resource(DownvoteQuestion,'/meetup/<string:id>/question/<string:questionid>/downvote','/meetup/<string:id>/question/<string:questionid>/downvote/')
api.add_resource(PostQuestion,'/meetup/<string:q_id>/question', '/meetup/<string:q_id>/question/' , '/meetup/<string:q_id>/question/','/meetup/<string:q_id>/question/')
api.add_resource(GetSpecificQuestion,'/meetup/<string:id>/question/<string:quizid>')
